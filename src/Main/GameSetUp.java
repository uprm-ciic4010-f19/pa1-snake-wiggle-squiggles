...
import Game.GameStates.ChoosePlayerState;
...
public class GameSetUp implements Runnable {
	...
	public State chooseplayerState;
	//Res.music
	...
	private void init(){
		...
		chooseplayerState = new ChoosePlayerState(handler);
	...
	private void render(){ 
		...
		g.drawImage(loading ,0,0,width,height,null); //draws the loading image
		if(State.getState() != null)
